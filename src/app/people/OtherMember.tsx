    ...
    <>
                                ...
                                (activity, index) => (
                                  <div
                                    ...
                                    className={`relative group flex items-start gap-4 p-4 ${
                                      activity?.label ? "pt-[3rem] md:pt-[3.5rem]" :
                                        ""
      ...
      {isLoading ? (
        ...
        <div className="bg-secondary p-7 px-5 md:p-9 md:px-[5rem]">
          ...
          <div className="container  membercards_team_members grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-5 gap-2 gap-y-7 md:gap-[1rem] lg:gap-[1.5rem]">
            {sortedTeam &&
